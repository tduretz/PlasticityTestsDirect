...
function ComputeStress!(τxx, τyy, τzz, τxy, Pc, Fc, Pl, εyyt,  x, P, P0, τxx0, τyy0, τzz0, τxy0, BC, BC_type, V_BC, σ_BC, rheo, iV, NumV, Δy, Δt )
...
function Res!(F, x, P, P0, τxx0, τyy0, τzz0, τxy0, ρ, Vx0, Vy0, BC, BC_type, V_BC, σ_BC, rheo, iV, NumV, Δy, Δt )
...
function main(σ0)
    ...
    Res_closed! = (F,x) -> Res!(F, x, P, P0, τxx0, τyy0, τzz0, τxy0, ρ, Vx0, Vy0, BC, BC_type, V_BC, σ_BC, rheo, iV, NumV, Δy, Δt )
    ...
    for it=1:Nt
        ...
        for iter=1:100
            ...
            if BC_type.Vy[end] == 2
                ...
                BC.y[2] = 2*V_BC.y.N - x[NumV.y[end]]
            end

            # Residual
            Res!(F, x, P, P0, τxx0, τyy0, τzz0, τxy0, ρ, Vx0, Vy0, BC, BC_type, V_BC, σ_BC, rheo, iV, NumV, Δy, Δt )
            @show (iter, norm(F))
        ...
        ComputeStress!(τxx, τyy, τzz, τxy, Pc, fc, pl, εyyt, x, P, P0, τxx0, τyy0, τzz0, τxy0, BC, BC_type, V_BC, σ_BC, rheo, iV, NumV, Δy, Δt )
        P .= Pc #!!!!!!!!!
