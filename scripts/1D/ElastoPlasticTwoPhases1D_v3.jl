...
function main(σ0)
    ...
    params = (
        #---------------#
        Ks  = 50e9,#6.6666666667e6, # K = 3/2*Gv in Vermeer (1990)
        Kf  = 2e9,#6.6666666667e6, # K = 3/2*Gv in Vermeer (1990)
        G   = 30e9,
        lc  = 0.01,  
        c   = 40e6,
        ϕ   = 40/180*π,
    ...
    sc   = (σ = params.G, L = 1e3, t = 1.0/params.γ̇xy)
